...
import 'package:flutter_providere/fish_model.dart';
import 'package:flutter_providere/seafish_model.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) =>
              SeaFishModel(name: 'Tuna', tunaNuber: 10, size: 'middle'),
        ),
      ],
      child: MaterialApp(
        home: FishOrder(),
...
class SpicyB extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(
          'Tuna number: ${Provider.of<SeaFishModel>(context).tunaNuber}',
          style: TextStyle(
              fontSize: 16, color: Colors.red, fontWeight: FontWeight.bold),
        ),
        Text(
...
class SpicyC extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      ElevatedButton(
          onPressed: () {
            Provider.of<FishModel>(context, listen: false).chageFishNumber();
          },
          child: Text('chageFishNumber'))
    ]);
  }
}
